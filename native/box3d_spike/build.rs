...
fn main() {
    ...
    println!("cargo:rerun-if-changed=src/box3d_spike_shim.c");
    println!("cargo:rerun-if-changed=src/box3d_spike_shim.h");
    ...
    build
        ...
        .file("src/box3d_spike_shim.c");

    for source_file in c_sources(&src_dir) {
        build.file(source_file);
    }

    build.compile("box3d_spike");
